    ...
    <div
      ...
      className={cn(
        `
          ...
          rounded-lg border-dashed p-12 text-center text-balance select-none
        `,
        className
      )}
      {...props}
...
function EmptyHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex max-w-sm flex-col items-center gap-2 select-none",
        className
      )}
      {...props}
    />
...
function EmptyDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <div
      ...
      className={cn(
        `
          text-sm/relaxed text-muted-foreground select-none
