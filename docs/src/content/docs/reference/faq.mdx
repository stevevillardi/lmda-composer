...
|---------|---------|-------|
| **Chrome** | <Badge text="Recommended" variant="success" /> | Full support for all features |
| **Edge** | <Badge text="Full Support" variant="success" /> | Same capabilities as Chrome |
| **Brave** | <Badge text="With Limitations" variant="note" /> | May need to enable File System Access API |
| **Firefox / Safari** | <Badge text="Not Supported" variant="caution" /> | Extension API limitations prevent support |
  ...
  <TabItem label="Create new modules?" icon="add-document">
    **Yes!** LMDA Composer includes a **Create LogicModule Wizard** that guides you through building new modules directly from the editor.
    ...
    <LinkCard
      ...
      description="Learn how to use the Create LogicModule wizard."
      href="/lmda-composer/module-management/creating-modules/"
    />
  </TabItem>
