...
| **Command Palette** | Press <kbd>Cmd</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> and type "Browse" |
...
| <ModuleTypeBadge type="logsource" /> | Filters, Log Fields, Resource Mappings (configured in Module Details) |
| <ModuleTypeBadge type="diagnosticsource" /> | Diagnostic Script |

<Aside type="note" title="LogSource Modules">
  LogSource modules don't have traditional scripts. Instead, they configure Filters, Log Fields, and Resource Mappings which are edited through the Module Details panel.
</Aside>
...
<Aside type="caution" title="Script Preview Empty">
  ...
  - LogSource modules use Filters/Log Fields instead of scripts
