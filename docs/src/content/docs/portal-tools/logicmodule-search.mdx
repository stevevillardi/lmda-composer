...
<CardGrid>
  ...
  <FeatureCard title="Keyboard Shortcut" icon="laptop" color="blue">
    Press <kbd>Cmd</kbd>+<kbd>K</kbd>, <kbd>S</kbd> to open directly.
  </FeatureCard>
</CardGrid>
