...
| **Command Palette** | Press <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> and type "Search" |
| **Keyboard Shortcut** | Press <kbd>Cmd</kbd>+<kbd>K</kbd>, <kbd>S</kbd> to open directly |
...
Search results include direct links to view the module on LogicMonitor Exchange when available. Click the <Icon name="external" size="1rem" /> icon to open the module in LMX.
