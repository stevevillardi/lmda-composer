...
<div class="screenshot-placeholder" style="background: var(--sl-color-gray-6); border: 2px dashed var(--sl-color-gray-4); border-radius: 0.5rem; padding: 2rem; text-align: center; margin: 1.5rem 0;">
  <Icon name="image" size="1.5rem" />
  <p style="margin: 0.5rem 0 0 0; color: var(--sl-color-gray-3); font-size: 0.8rem;">
    Screenshot: api-history.png<br />
    <em>History sidebar showing past API requests</em>
  </p>
</div>
