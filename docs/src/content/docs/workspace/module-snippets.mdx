...
import { Steps, Tabs, TabItem, Aside, Badge, LinkCard, Code } from '@astrojs/starlight/components';
...
| **Command Palette** | Press <kbd>Cmd</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> and type "Module Snippets" |
