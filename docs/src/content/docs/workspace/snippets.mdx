...
<CardGrid>
  ...
  <Card title="Keyboard Shortcut" icon="laptop">
    Press <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>U</kbd> / <kbd>⌘</kbd>+<kbd>Shift</kbd>+<kbd>U</kbd> to open directly.
  </Card>
