...
|-----------|----------|-------|
| <Badge text=".groovy" variant="success" /> | Groovy | Groovy scripts |
| <Badge text=".ps1" variant="note" /> | PowerShell | PowerShell scripts |
| <Badge text=".txt" variant="default" /> | Plain text | Uses tab language setting |
...
| **Keyboard** | Press <kbd>Ctrl</kbd>+<kbd>K</kbd>, <kbd>O</kbd> / <kbd>Cmd</kbd>+<kbd>K</kbd>, <kbd>O</kbd> |
...
| Method | Action |
|--------|--------|
| **Keyboard** | Press <kbd>Cmd</kbd>+<kbd>K</kbd>, <kbd>F</kbd> to open directly |
...
|---------|---------|-------|
| **Chrome** | <StatusBadge status="success" label="Full Support" /> | Direct file reading/writing, file handles persist across sessions |
| **Edge** | <StatusBadge status="success" label="Full Support" /> | Same capabilities as Chrome |
| **Brave/Vivaldi** | <StatusBadge status="warning" label="Requires Setup" /> | May need to enable the File System Access API flag |
